    ...
    <div class="d-flex" id="wrapper">
      ...
      <div class="bg-white" id="sidebar-wrapper">
        ...
        <div class="list-group list-group-flush my-3">
          <a
            href="../admin_pages/admindashboard.html"
            class="list-group-item list-group-item-action bg-transparent second-text fw-bold"
            ><i class="fas fa-tachometer-alt me-2"></i>Dashboard</a
          >

          <a
            href="../admin_pages/groupteacher.html"
            class="list-group-item list-group-item-action bg-transparent second-text fw-bold"
            ><i class="fas fa-brands fa-wpforms me-2"></i>Assignment of mentors
          </a>

          <a
            href="../admin_pages/uploadrubrics.html"
            class="list-group-item list-group-item-action bg-transparent second-text fw-bold e"
            ><i class="fas fa-solid fa-scroll me-2"></i>Upload rubrics</a
          >

          <a
            href="../admin_pages/validategroups.php"
          ...
          <!-- <a
            href="../teacher_pages/ViewReport.html"
            class="list-group-item list-group-item-action bg-transparent second-text fw-bold"
            ><i class="fas fa-solid fa-address-card me-2"></i>View report</a
          > -->

          <a
            href="../admin_pages/admin_signin.html"
        ...
        >
          <div class="d-flex align-items-center">
            <i
              ...
              id="menu-toggle"
            ></i>
            <h2 class="fs-2 m-0">Validate groups</h2>
          </div>
...
<div class="container-fluid px-4">
    ...
    <thead>
        <tr>
            ...
            <th style="background-color: rgb(88, 88, 241)">Validation Status</th>
            <th style="background-color: rgb(88, 88, 241)">Actions</th>
        </tr>
    </thead>
    <tbody>
        <?php while ($group = mysqli_fetch_assoc($groupInfoResult)) { ?>
            <?php
            ...
            if (!in_array($group['groupno'], $displayedGroups)) {
                ...
                <tr>
                    ...
                    <td
                        style="background-color: <?php echo ($group['validate'] == 1) ? 'rgb(39, 245, 39)' : 'red'; ?>"
                    >
                        <?php echo ($group['validate'] == 1) ? 'Validated' : 'Not Validated'; ?>
                    </td>
                    <td>
                        <a
                            href="view_group_info.php?groupno=<?php echo $group['groupno']; ?>"
