...
$groupInfoQuery = "SELECT groupno FROM evaluation1";
...
<html lang="en">
  <head>
    ...
    <title>Veiw evaluation hod</title>
  </head>
    ...
    <div class="d-flex" id="wrapper">
      ...
      <div class="bg-white" id="sidebar-wrapper">
        ...
        <a
          ...
          <a
            href="../hod_pages/view_groups_hod.php"
            class="list-group-item list-group-item-action bg-transparent second-text fw-bold"
          ...
          <a
            ...
            class="list-group-item list-group-item-action bg-transparent second-text fw-bold activ"
        ...
        >
          <div class="d-flex align-items-center">
            <i
              ...
              id="menu-toggle"
            ></i>
            <h2 class="fs-2 m-0">View Evaluation</h2>
          </div>
        ...
        <tbody>
          ...
          while ($group = mysqli_fetch_assoc($groupInfoResult)) {
            if (!in_array($group['groupno'], $displayedGroups)) {
              $displayedGroups[] = $group['groupno'];
              ?>
              <tr>
                <td>Group <?php echo $group['groupno']; ?></td>
                <td>
                  <a href="view_evaluation_inside.php?groupno=<?php echo $group['groupno']; ?>"
